...
class ActivityEventType(StrEnum):
    ...
    DEADLINE_CHANGE_CONFIRMATION = "deadline_change_confirmation"
    DEADLINE_REQUIRED_CONFIRMATION = "deadline_required_confirmation"
    RETRACTION_CONFIRMATION = "retraction_confirmation"
